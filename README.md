...
<p>It provides a fully functional login/register system and implements two roles. The roles of admin and customer. Customers have the option to favourite products , add products to their cart and pay for them. Once payment is complete, customers have the option to view previous order details and the shipping method that was used. Admin has his own dashboard, where he can analyze the performance of the website with the help of charts, insert/edit new products and view all the products of the website.
